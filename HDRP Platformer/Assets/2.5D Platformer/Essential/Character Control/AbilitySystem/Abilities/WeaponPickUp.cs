...
namespace Roundbeargames
{
    ...
    public class WeaponPickUp : CharacterAbility
    {
        ...
        {
            characterState.DATASET.WEAPON_DATA.HoldingWeapon =
        ...
        public override void UpdateAbility(CharacterState characterState, Animator animator, AnimatorStateInfo stateInfo)
        {
            if (stateInfo.normalizedTime > PickUpTiming)
            {
                try
                {
                    if (characterState.DATASET.WEAPON_DATA.HoldingWeapon.control == null)
                    {
                        MeleeWeapon w = characterState.DATASET.WEAPON_DATA.HoldingWeapon;
